 ...
 */
public class SnakePropertyPlaceholder implements BeanFactoryPostProcessor {
    private Resource[] locations;
    private final Logger log = Logger.getLogger(SnakePropertyPlaceholder.class);
    @Override
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        ...
        try {
            ...
            StringValueResolver stringValueResolver=new SnakeStringValueResolver();
            ...
            throw new BeansException(" reset beanname("+bname+") property("+pname+") value exception:"+e.getMessage(),e){};
