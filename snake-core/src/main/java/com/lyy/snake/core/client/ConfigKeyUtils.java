...
import com.lyy.snake.core.exceptions.ConfigKeyPatternException;
...
public class ConfigKeyUtils {
    ...
    public static String zkNodePathToConfigKey(String zkNodePath){
        ...
        if (configKeySubPath.startsWith("/")){
            configKeySubPath = configKeySubPath.substring(1,configKeySubPath.length());
        }
